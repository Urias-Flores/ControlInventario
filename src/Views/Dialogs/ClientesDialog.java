...
import ViewsControllers.Dialogs.ClientesDialogViewController;

public class ClientesDialog extends javax.swing.JDialog {

    private int X, Y;
    private Cliente cliente = new Cliente();
    private ClientesDialogViewController vc;
    ...
    public ClientesDialog(java.awt.Frame parent, boolean modal) {
        ...
        vc = new ClientesDialogViewController(txtBuscar, lbCargando, tbEmpleados);
    ...
    private void btnSeleccionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSeleccionarMouseClicked
        ...
        if(fila >= 0){
            cliente = (Cliente) tbEmpleados.getValueAt(fila, 1);
            this.setVisible(false);
        }else{
