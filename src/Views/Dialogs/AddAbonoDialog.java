...
public class AddAbonoDialog extends javax.swing.JDialog {
    ...
    public AddAbonoDialog(java.awt.Frame parent, boolean modal) {
        ...
        vc = new AddAbonoDialogViewController(lbFactura, lbDeudaTotal, lbTotalAbonado, lbDeudaPendiente, tbAbonos, txtTotalAbono, txtTotalPendiente, lbError);
    }
    
    public void setFactura(int TransaccionID, String type){
        switch (type) {
            case "V":
                vc.setVenta(TransaccionID);
                break;
            case "C":
                vc.setCompra(TransaccionID);
                break;
            default:
