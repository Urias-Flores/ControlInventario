...
import ViewsControllers.Dialogs.AddCategoriDialogViewController;
...
public class AddCategoriaDialog extends javax.swing.JDialog {
    ...
    private void addDesing(){
        txtNombre.putClientProperty("JTextField.placeholderText", "Ingrese el nombre de la categoria...");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCategoriaDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            AddCategoriaDialog dialog = new AddCategoriaDialog(new javax.swing.JFrame(), true);
