...
public class NotificacionesDialog extends javax.swing.JDialog {
    ...
    private NotificacionesDialogViewController vc;
    private int X, Y;
    
    public NotificacionesDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        btnClose.addMouseListener(Utilities.getMLButtonCloseBlue());
        pnNotificaciones.setLayout(new BoxLayout(pnNotificaciones, BoxLayout.Y_AXIS));
        
        vc = new NotificacionesDialogViewController(pnNotificaciones);
        vc.cargarNotificaciones();
    }
    ...
    private void initComponents() {
        ...
        pnNotificaciones.setBackground(new java.awt.Color(255, 255, 255));
        jScrollPane2.setViewportView(pnNotificaciones);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificacionesDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            NotificacionesDialog dialog = new NotificacionesDialog(new javax.swing.JFrame(), true);
